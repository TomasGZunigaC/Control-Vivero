...
export const save = (emp) => {
    ...
    addDoc(collection(db, 'Clientes'), emp)
}
...
export const getData = (data) => {
    ...
    onSnapshot(collection(db, 'Clientes'), data)
}
