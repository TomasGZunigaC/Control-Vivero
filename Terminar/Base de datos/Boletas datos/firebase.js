...
export const save = (emp) => {
    ...
    addDoc(collection(db, 'Boletas'), emp)
}
...
export const getData = (data) => {
    ...
    onSnapshot(collection(db, 'Boletas'), data)
}
