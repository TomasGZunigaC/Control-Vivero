...
export const save = (emp) => {
    ...
    addDoc(collection(db, 'Productos'), emp)
}
...
export const getData = (data) => {
    ...
    onSnapshot(collection(db, 'Productos'), data)
}
...
export const obtener = (id) => getDoc(doc(db,'Productos',id))
...
export const update = (id,Productos) =>{
    ...
    updateDoc(doc(db,'Productos',id),Productos)
}
