...
document.getElementById('btnGuardar').addEventListener('click', () => {
    ...
    if (document.querySelectorAll('.is-invalid').length == 0) {
        if (document.getElementById('btnGuardar').value == 'Guardar') {
            const Cliente = {
                'Run': document.getElementById('ClienteRut').value,
                'nom': document.getElementById('ClienteNom').value.trim(),
                'fono': document.getElementById('Clientefono').value,
    ...
    getData((collection) => {
        ...
        document.querySelectorAll('.btn-warning').forEach( btn => {
            ...
            btn.addEventListener('click',async() =>{
                ...
                document.getElementById('ClienteRut').value = d.PRun
                document.getElementById('ClienteNom').value = d.nom
                document.getElementById('Clientefono').value = d.fono
                document.getElementById('ClienteMail').value = d.mail
