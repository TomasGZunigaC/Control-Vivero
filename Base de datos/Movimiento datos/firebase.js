...
export const save = (emp) => {
    ...
    addDoc(collection(db, 'Movimiento'), emp)
}
...
export const getData = (data) => {
    ...
    onSnapshot(collection(db, 'Movimiento'), data)
}
